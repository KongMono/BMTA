...
namespace BMTA
{
    public partial class BMTA_Abouts_en : PhoneApplicationPage
    {
        public BMTA_Abouts_en()
        {
            InitializeComponent();
        ...
        private void PhoneApplicationPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                if (x == "480")
                {
                    ...
                    {
                        ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("/Assets/480x852/BMTA_abouts_en.png", UriKind.Relative)),
                        Opacity = 1d
                    };
                ...
                else if (x == "720")
                {
                    ImageBrush brush = new ImageBrush
                    {
                        ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("/Assets/720x1280/BMTA_abouts_en.png", UriKind.Relative)),
                        Opacity = 1d
                    };
                    this.LayoutRoot.Background = brush;
                    brush.Stretch = Stretch.Fill;
                ...
                else
                {
                    ImageBrush brush = new ImageBrush
                    {
                        ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("/Assets/768x1280/BMTA_abouts_en.png", UriKind.Relative)),
                        Opacity = 1d
                    };
                    this.LayoutRoot.Background = brush;
                    brush.Stretch = Stretch.Fill;
        ...
        private void btnew_Click(object sender, RoutedEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri("/BMTA_Abouts_details_en.xaml?key=" + _button.Tag.ToString(), UriKind.Relative));
        ...
        private void btvision_Click(object sender, RoutedEventArgs e)
        {
            //  MessageBox.Show();
            Button _button = (Button)sender;
            NavigationService.Navigate(new Uri("/BMTA_Vision_details_en.xaml?key=" + _button.Tag.ToString(), UriKind.Relative));
