...
namespace BMTA
{
    public partial class BMTA_BusLandMarkDetailMap : PhoneApplicationPage
    {
        ...
        public BMTA_BusLandMarkDetailMap()
        {
            InitializeComponent();
            ShowMyLocationOnTheMap();

            new_searchfindRoutingItem_data data = (Application.Current as App).RountingDataLandMark;
        ...
        {
            this.NavigationService.Navigate(new Uri("/BMTA_BusLandMarkDetailList.xaml?TextFrom=" + busstop_search.Text, UriKind.Relative));
        }
    }
}