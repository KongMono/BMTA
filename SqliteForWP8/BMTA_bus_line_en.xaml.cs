...
namespace BMTA
{
    public partial class BMTA_bus_line_en : PhoneApplicationPage
    {
        /// <summary>
        /// The database path.
        /// </summary>
        ...
        private void PhoneApplicationPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                //sqlComm.CommandText = "SELECT * FROM busline Group by bus_line ";
                sqlComm.CommandText = "SELECT * FROM busline where bus_line !='' and bus_line LIKE '1%' Group by bus_line";
                ...
                if (x == "480")
                {
                    ...
                    {
                        ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("/Assets/480x852/BMTA_busline_bg_en.png", UriKind.Relative)),
                        Opacity = 1d
                    };
                ...
                else if (x == "720")
                {
                    ImageBrush brush = new ImageBrush
                    {
                        ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("/Assets/720x1280/BMTA_busline_bg_en.png", UriKind.Relative)),
                        Opacity = 1d
                    };
                    this.LayoutRoot.Background = brush;
                    brush.Stretch = Stretch.Fill;
                ...
                else
                {
                    ImageBrush brush = new ImageBrush
                    {
                        ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("/Assets/768x1280/BMTA_busline_bg_en.png", UriKind.Relative)),
                        Opacity = 1d
                    };
                    this.LayoutRoot.Background = brush;
                    brush.Stretch = Stretch.Fill;
        ...
        {
            NavigationService.Navigate(new Uri("/BMTA_SearchAdvance_en.xaml", UriKind.Relative));
        }
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri("/BMTA_bus_line_details_en.xaml?key=" + _button.Tag.ToString(), UriKind.Relative));
