...
namespace BMTA
{
    public partial class BMTA_EventNew_en : PhoneApplicationPage
    {
        public BMTA_EventNew_en()
        {
            InitializeComponent();
        ...
        private void PhoneApplicationPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                else if (x == "720")
                {
                    ImageBrush brush = new ImageBrush
                    {
                        ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("/Assets/720x1280/BMTA_event_new_en.png", UriKind.Relative)),
                        Opacity = 1d,
                    };
                    this.LayoutRoot.Background = brush;
                    brush.Stretch = Stretch.Fill;
        ...
        {
            NavigationService.Navigate(new Uri("/BMTA_Slot_en.xaml", UriKind.Relative));

        }

        private void Button_Click3(object sender, RoutedEventArgs e)
        {
            NavigationService.Navigate(new Uri("/BMTA_Abouts_en.xaml", UriKind.Relative));
        }

        private void Button_Click1(object sender, RoutedEventArgs e)
        {
            NavigationService.Navigate(new Uri("/BMTA_News_en.xaml", UriKind.Relative));
        }
