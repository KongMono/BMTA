...
namespace BMTA
{
    public partial class BMTA_News_en : PhoneApplicationPage
    {
        ...
        private void btnew_Click(object sender, RoutedEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri("/BMTA_News_details_en.xaml?key=" + _button.Tag.ToString() + "&subject=" + subject.ToString() + "&img=" + img.ToString(), UriKind.Relative));
