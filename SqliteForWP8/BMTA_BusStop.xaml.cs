...
namespace BMTA
{
    public partial class BMTA_BusStop : PhoneApplicationPage
    {
        ...
        public void getNearBusStop()
        {
            ...
            string url = "http://202.6.18.31/bmta/webservice/bmta_server_bo.php/";
            ...
            "<soap:Body>\n" +
            "<getNearBusStop xmlns=\"http://202.6.18.31/bmta/webservice/bmta_server_bo.php\">\n" +
            "<lat>" + lat + "</lat>\n" +
            "<long>" + lon + "</long>\n" +
            ...
            request.Headers["SOAPAction"] = "http://202.6.18.31/bmta/webservice/bmta_server_bo.php?wsdl";
        ...
        private void LoadAvalableParks()
        {
            try
            {
                ...
                //   LocationListobj.Add(new LocationDetail { id = "4555", stop_name = "\u0e2a\u0e19.\u0e1a\u0e32\u0e07\u0e0b\u0e37\u0e48\u0e2d", latitude = "13.78643295", longitude = "100.5472505", distance = "8,502,59,26,34,39,503,54,63,97,74,77,112,204,159,38,27" });
                //   LocationListobj.Add(new LocationDetail { id = "3784", stop_name = "\u0e2d\u0e34\u0e19\u0e17\u0e32\u0e21\u0e30\u0e23\u0e30 \u0e0b\u0e2d\u0e22 4", latitude = "13.7888747977585", longitude = "100.552852584891", distance = "74,204,117" });
                //    LocationListobj.Add(new LocationDetail { id = "28", stop_name = "\u0e42\u0e23\u0e21\u0e41\u0e23\u0e21\u0e2a\u0e38\u0e14\u0e32", latitude = "13.7889843406627", longitude = "100.550733714057", distance = "54,74,204,117" });
                //    LocationListobj.Add(new LocationDetail { id = "4658", stop_name = "\u0e40\u0e2d.\u0e44\u0e2d.\u0e40\u0e2d\u0e2a.,\u0e15\u0e23\u0e07\u0e02\u0e49\u0e32\u0e21 \u0e2a\u0e19.\u0e1a\u0e32\u0e07\u0e0b\u0e37\u0e48\u0e2d", latitude = "13.78650073191369", longitude = "100.5469870418558", distance = "8,59,26,29,34,39,503,54,63,97,74,77,509,502,112,510,38,27" });
                //    LocationListobj.Add(new LocationDetail { id = "4556", stop_name = "\u0e0b\u0e2d\u0e22\u0e2a\u0e32\u0e22\u0e25\u0e21", latitude = "13.7835003865488", longitude = "100.546028461248", distance = "8,502,59,26,29,34,39,503,54,63,97,74,77,509,112,204,38,27" });
                //   LocationListobj.Add(new LocationDetail { id = "6", stop_name = "West Bank Office Building Ramp", latitude = "44.976288", longitude = "-93.248582", distance = "7" });
                ...
                if (responetext != "")
                {
                    ...
                    map.Center = MyCoordinates[MyCoordinates.Count - 1];
                    //  MapVieMode.ZoomLevel = 14;
                    Dispatcher.BeginInvoke(() =>
                    {
                        map.SetView(LocationRectangle.CreateBoundingRectangle(MyCoordinates));
                    });
                    // MapVieMode.SetView(LocationRectangle.CreateBoundingRectangle(from 1 in MyCoordinates);
                    map.SetView(MyCoordinates[MyCoordinates.Count - 1], 10, MapAnimationKind.Linear);
                }
                else
                {
                    GetLocation();
        ...
        private void btBusStop_Click(object sender, RoutedEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri("/BMTA_BusStop_pin_en.xaml?_busline=" + _button.Tag.ToString() + "&stop_name=" + _stop_name.ToString(), UriKind.Relative));
            ...
            try
            {
                ...
                if (selectedparkdata.Count > 0)
                {
                    ...
                    ContextMenuService.GetContextMenu(item);
                        ...
                        NavigationService.Navigate(new Uri("/BMTA_BusStop_pin_en.xaml", UriKind.Relative));
                        break;
        ...
        {
            NavigationService.Navigate(new Uri("/BMTA_Search_Advance_busstop_en.xaml", UriKind.Relative));
        }
